          ...
          <VStack spacing={5} align="stretch">
            <FormControl>
              ...
              <Text fontSize="xs" color="gray.400" mt={1} fontStyle="italic">
                Your midwife or doctor will have given you this date
              </Text>
            </FormControl>
    ...
    <Layout>
      <Box maxW="480px" w="100%" mt={8} pb={16}>
        ...
        >
          ...
          <Heading fontSize="6xl" lineHeight="1" mb={1}>
            {weeks}
          </Heading>
          <Text fontSize="lg" opacity={0.85} fontWeight="300">
            weeks pregnant
          </Text>
        ...
        <Grid templateColumns="1fr 1fr" gap={3} mb={4}>
          ...
          <GridItem bg="white" borderRadius="2xl" p={5} boxShadow="sm">
            ...
            <Heading fontSize="lg" color="gray.700">
              {formatDueDate(userData.dueDate)}
            </Heading>
          </GridItem>
        </Grid>
